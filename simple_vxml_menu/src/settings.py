# Django settings for simple_vxml_menu project.
...
DATABASES = {
    'default': {
        'ENGINE': '@db.backends@', # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
...
SECRET_KEY = '$&x5%j)bg3*)rg_jao8g52*u_6oq^2vhv74ud11hqk&i_(o^3u'
...
ROOT_URLCONF = 'simple_vxml_menu.urls'
